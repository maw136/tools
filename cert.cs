public static void Main()
    ...
    private static Tuple<X509Certificate, AsymmetricKeyParameter> GenerateCertificate(
        string subjectName,
    ...
    private static string ToBase64(Tuple<X509Certificate, AsymmetricKeyParameter> certAndKey)
    {
